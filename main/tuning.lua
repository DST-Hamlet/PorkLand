...
TUNING.WOLFGANG_HUNGER_RATE_MULT_MIGHTY_START = TUNING.WOLFGANG_HUNGER_RATE_MULT_NORMAL * 1.25
TUNING.WOLFGANG_HUNGER_RATE_MULT_MIGHTY = TUNING.WOLFGANG_HUNGER_RATE_MULT_NORMAL * 1.5

TUNING.WOLFGANG_HUNGER_RATE_MULT_WIMPY_START = TUNING.WOLFGANG_HUNGER_RATE_MULT_NORMAL * 0.75
