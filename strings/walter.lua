return {
    ...
    DESCRIBE = {
        ...
        CITY_LAMP = {
            GENERIC = "Bright street thanks to them.",
            ON = "A street lamp.",
        },
        ...
        PIG_GUARD_TOWER = {
            BURNING = "It's burning! Woby let's go help!",
            GENERIC = "This must be where the knight lives.",
        },
        ...
        SUNKEN_RELIC = "Look, Warby! Is there something in the water?",
        ...
        TUBERTREE = "A parsnip?",
        TUBER_BLOOM_CROP = "Tuber with flower.",
        TUBER_BLOOM_CROP_COOKED = "It looks pretty tempting.",
        TUBER_CROP = "I wonder what it tastes like now?",
        TUBER_CROP_COOKED = "Seems not bad.",
