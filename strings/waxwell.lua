return {
    ...
    DESCRIBE = {
        ...
        SHELF_ADJUSTABLE = "A place to put my books.",
        SHELF_AFRAME = "I suppose this works.",
        SHELF_BASIC = "A bit basic, but it'll do.",
        SHELF_CINDERBLOCKS = "Interesting choice of decor.",
        SHELF_CRATES = "Interesting choice of decor.",
        SHELF_FLOATING = "Interesting choice of decor.",
        SHELF_FRIDGE = "Interesting choice of decor.",
        SHELF_GLASS = "Looks breakable.",
        SHELF_HATTREE = "I suppose this works.",
        SHELF_HOOKS = "Ah. A place to put my books.",
        SHELF_HUTCH = "Ah. A place to put my books.",
        SHELF_INDUSTRIAL = "Philistine.",
        SHELF_LADDER = "Boorish.",
        SHELF_MARBLE = "I have the perfect book for that bookshelf.",
        SHELF_METAL = "A little industrial for my tastes.",
        SHELF_MIDCENTURY = "Ah. A place to put my books.",
        SHELF_PALLET = "Interesting choice of decor.",
        SHELF_PIPE = "I suppose this works.",
        SHELF_WALLMOUNT = "Stable enough.",
        SHELF_WOOD = "Ah. A place to put my books.",
        SLUGBUG = "Loathsome.",
        SLUGBUG_COOKED = "Ugh!",
