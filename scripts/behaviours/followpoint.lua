FollowPoint = Class(BehaviourNode, function(self, inst, target, min_dist, target_dist, max_dist, canrun, alwayseval, inlimbo_invalid)
...
function FollowPoint:AreDifferentPlatforms(inst, target)
