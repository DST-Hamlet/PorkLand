...
local assets =
{
    Asset("ANIM", "anim/flamingo.zip"),
    Asset("ANIM", "anim/flamingo_salt.zip"),
...
local loot_salt = { "meat", "meat","saltrock" }
...
local function ClearSalt(inst)
    inst.AnimState:SetBuild("flamingo")
    inst.components.lootdropper:SetLoot(loot)
end

local function SetSalt(inst)
    inst.AnimState:SetBuild("flamingo_salt")
    inst.components.lootdropper:SetLoot(loot_salt)
end
...
local function fn()
    ...
    inst.AnimState:SetBank("flamingo")
    inst.AnimState:SetBuild("flamingo")
    ...
    MakeAmphibious(inst, "tallbird", "tallbird", nil, OnEnterWater, OnExitWater)
    ...
    inst.ClearSalt = ClearSalt
    inst.SetSalt = SetSalt
...
return Prefab("flamingo", fn, assets, prefabs)