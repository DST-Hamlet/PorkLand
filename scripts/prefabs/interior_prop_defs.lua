...
local room_creatures  = {
    {
        {name = "pl_bat", x_offset = (math.random()*7) - (7/2), z_offset = (math.random()*13) - (13/2)},
        {name = "pl_bat", x_offset = (math.random()*7) - (7/2), z_offset = (math.random()*13) - (13/2)},
    },
    {
        {name = "pl_bat", x_offset = (math.random()*7) - (7/2), z_offset = (math.random()*13) - (13/2)},
...
PROP_DEFS.vampirebatcave_common = function(exterior_door_def, height, width,room)
    local addprops = {}
    if room.is_entrance then
        addprops = {
            {
...
PROP_DEFS.vampirebatcave = function(exterior_door_def, height, width, room)
    local addprops = PROP_DEFS.vampirebatcave_common(exterior_door_def, height, width,room)

    addprops[#addprops + 1] = {name = "deco_cave_cornerbeam", x_offset = -height / 2, z_offset = -width / 2}
    addprops[#addprops + 1] = {name = "deco_cave_cornerbeam", x_offset = -height / 2, z_offset = width / 2, flip = true}

    addprops[#addprops + 1] = {name = "deco_cave_pillar_side", x_offset = height / 2, z_offset = -width / 2}
    addprops[#addprops + 1] = {name = "deco_cave_pillar_side", x_offset = height / 2, z_offset = width / 2, flip = true}

    addprops[#addprops + 1] = {name = "deco_cave_bat_burrow", x_offset = 0, z_offset = 0}

    addprops[#addprops + 1] = {name = "deco_cave_floor_trim_front", x_offset = height/2, z_offset = -width / 4}
    addprops[#addprops + 1] = {name = "deco_cave_floor_trim_front", x_offset = height/2, z_offset = 0, addtags = {"roc_cave_delete_me"}, roc_cave_delete_me = true}
    addprops[#addprops + 1] = {name = "deco_cave_floor_trim_front", x_offset = height/2, z_offset = width / 4}

    addprops[#addprops + 1] = {name = "deco_cave_floor_trim_2", x_offset = math.random() * height / 2 - height / 4, z_offset = -width / 2, chance = 0.7}
    addprops[#addprops + 1] = {name = "deco_cave_floor_trim_2", x_offset = math.random() * height / 2 - height / 4, z_offset = width / 2, flip = true, chance = 0.7}

    addprops[#addprops + 1] = {name = "deco_cave_ceiling_trim_2", x_offset = math.random() * height / 2 - height / 4, z_offset = -width / 2, chance = 0.7}
    addprops[#addprops + 1] = {name = "deco_cave_ceiling_trim_2", x_offset = math.random() * height / 2 - height / 4, z_offset = width / 2, flip = true, chance = 0.7}

    addprops[#addprops + 1] = {name = "deco_cave_beam_room", x_offset = math.random() * height * 0.65 - 0.65 * height / 2, z_offset = GetPosToCenter(width * 0.65, 7, false, true), chance = 0.5}
    addprops[#addprops + 1] = {name = "deco_cave_beam_room", x_offset = math.random() * height * 0.65 - 0.65 * height / 2, z_offset = GetPosToCenter(width * 0.65, 7), chance = 0.5}

    addprops[#addprops + 1] = {name = "flint", x_offset = GetPosToCenter(height * 0.65, 3, true), z_offset = GetPosToCenter(width * 0.65, 3, true)}
    addprops[#addprops + 1] = {name = "flint", x_offset = GetPosToCenter(height * 0.65, 3, true), z_offset = GetPosToCenter(width * 0.65, 3, true), chance = 0.5}

    addprops[#addprops + 1] = {name = "stalagmite", x_offset = GetPosToCenter(height * 0.65, 4, true), z_offset = GetPosToCenter(width * 0.65, 4, true)}
    addprops[#addprops + 1] = {name = math.random() < 0.5 and "stalagmite" or "stalagmite_tall", x_offset = GetPosToCenter(height * 0.65, 4, true), z_offset = GetPosToCenter(width * 0.65, 4, true), chance = 0.5}
    addprops[#addprops + 1] = {name = "stalagmite_tall", x_offset = GetPosToCenter(height * 0.65, 3, true), z_offset = GetPosToCenter(width * 0.65, 3, true), chance = 0.5}

    addprops[#addprops + 1] = {name = "deco_cave_stalactite", x_offset = math.random() * height / 2 - height / 4, z_offset = GetPosToCenter(width, 6, true), chance = 0.5}
    addprops[#addprops + 1] = {name = "deco_cave_stalactite", x_offset = math.random() * height / 2 - height / 4, z_offset = GetPosToCenter(width, 6, true), chance = 0.5}
    addprops[#addprops + 1] = {name = "deco_cave_stalactite", x_offset = math.random() * height / 2 - height / 4, z_offset = GetPosToCenter(width, 6, true), chance = 0.5}
    addprops[#addprops + 1] = {name = "deco_cave_stalactite", x_offset = math.random() * height / 2 - height / 4, z_offset = GetPosToCenter(width, 6, true), chance = 0.5}
