...
PROP_DEFS.anthill_common = function(depth, width, room, doorway_count, doorway_prefabs)
    local addprops = {}
...
PROP_DEFS.anthill_empty = function(depth, width, room, doorway, doorway_prefabs)
    -- creating a seperate table here to not randomise addprops_common, don't want to move all the pillars and doors in it
    local addprops = {}
    local addprops_common = PROP_DEFS.anthill_common(depth, width, room, doorway, doorway_prefabs)
...
PROP_DEFS.anthill_ant_home = function(depth, width, room, doorway, doorway_prefabs)
    local addprops = {}
    local addprops_common = PROP_DEFS.anthill_common(depth, width, room, doorway, doorway_prefabs)
...
PROP_DEFS.anthill_wandering_ant = function(depth, width, room, doorway, doorway_prefabs)
    local addprops = {}
    local addprops_common = PROP_DEFS.anthill_common(depth, width, room, doorway, doorway_prefabs)
...
PROP_DEFS.anthill_treasure = function(depth, width, room, doorway, doorway_prefabs)
    local addprops = {}
    local addprops_common = PROP_DEFS.anthill_common(depth, width, room, doorway, doorway_prefabs)
