...
return MakeShop("pig_shop_deli",            "pig_shop_deli",        nil,            {sounds = {SHOPSOUND_ENTER1, SHOPSOUND_ENTER2}}),
       ...
       MakePlacer("pig_shop_deli_placer",        "pig_shop",     "pig_shop_deli",        "idle", nil, true, nil, nil, nil, nil, HideLayers),
       MakePlacer("pig_shop_general_placer",     "pig_shop",     "pig_shop_general",     "idle", nil, true, nil, nil, nil, nil, HideLayers),
       MakePlacer("pig_shop_hoofspa_placer",     "pig_shop",     "pig_shop_hoofspa",     "idle", nil, true, nil, nil, nil, nil, HideLayers),
       MakePlacer("pig_shop_produce_placer",     "pig_shop",     "pig_shop_produce",     "idle", nil, true, nil, nil, nil, nil, HideLayers),
       MakePlacer("pig_shop_florist_placer",     "pig_shop",     "pig_shop_florist",     "idle", nil, true, nil, nil, nil, nil, HideLayers),
       MakePlacer("pig_shop_antiquities_placer", "pig_shop",     "pig_shop_antiquities", "idle", nil, true, nil, nil, nil, nil, HideLayers),
       MakePlacer("pig_shop_arcane_placer",      "pig_shop",     "pig_shop_arcane",      "idle", nil, true, nil, nil, nil, nil, HideLayers),
       MakePlacer("pig_shop_weapons_placer",     "pig_shop",     "pig_shop_weapons",     "idle", nil, true, nil, nil, nil, nil, HideLayers),
       MakePlacer("pig_shop_hatshop_placer",     "pig_shop",     "pig_shop_millinery",   "idle", nil, true, nil, nil, nil, nil, HideLayers),
       MakePlacer("pig_shop_cityhall_placer",    "pig_cityhall", "pig_cityhall",         "idle", nil, true, nil, nil, nil, nil, HideLayers),
       MakePlacer("pig_shop_bank_placer",        "pig_shop",     "pig_shop_bank",        "idle", nil, true, nil, nil, nil, nil, HideLayers),
       MakePlacer("pig_shop_tinker_placer",      "pig_shop",     "pig_shop_tinker",      "idle", nil, true, nil, nil, nil, nil, HideLayers)
