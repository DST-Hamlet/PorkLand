...
return  DecoCreator:Create("deco_antiquities_screamcatcher",   "ceiling_decor",                     "ceiling_decor",              "scream_catcher_idle", {loopanim = true}),
        ...
        DecoCreator:Create("deco_antiquities_beefalo",         "interior_wallornament",             "interior_wallornament",      "beefalo",             {decal = true, tags = {"wallsection"}, onbuilt = true, on_built_fn = on_wall_ornament_built}),
        ...
        DecoCreator:Create("deco_antiquities_wallfish",        "interior_wallornament",             "interior_wallornament",      "fish",                {decal = true, background = 3, tags = {"NOBLOCK", "wallsection"}, onbuilt = true, on_built_fn = on_wall_ornament_built}),
