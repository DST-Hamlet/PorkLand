local TRADER = {
    ...
    pigman_beautician = {
        ...
        reset = 1,
        desc = "CITY_PIG_BEAUTICIAN_TRADE",
        reward = "oinc",
        rewardqty = 2
    },
    ...
    pigman_storeowner = {
        items = { "clippings" },
        reset = 0,
        desc = "CITY_PIG_STOREOWNER_TRADE",
        reward = "oinc",
        rewardqty = 1
    },
