...
local states =
{
    State
    {
        ...
        onenter = function(inst, nextState)
            ...
            -- inst.SoundEmitter:PlaySound("pl/creatures/enemy/giant_grub/emerge")
            inst:SetState("above")
        ...
        timeline =
        {
            TimeEvent(16* FRAMES,function (inst) inst.SoundEmitter:PlaySound("pl/creatures/enemy/giant_grub/emerge")
            end),
        },
    ...
    State
    {
        ...
        timeline =
        {
            ...
            TimeEvent(1* FRAMES, function(inst) inst.SoundEmitter:PlaySound("pl/creatures/enemy/giant_grub/jump") end),
            ...
            TimeEvent(20* FRAMES, function(inst)
                ...
                inst.SoundEmitter:PlaySound("pl/creatures/enemy/giant_grub/submerge")
            end),

            TimeEvent(33* FRAMES, function(inst) inst.SoundEmitter:PlaySound("pl/creatures/enemy/giant_grub/dig") end),
            TimeEvent(39* FRAMES, function(inst) inst.SoundEmitter:PlaySound("pl/creatures/enemy/giant_grub/dig") end),
            TimeEvent(49* FRAMES, function(inst) inst.SoundEmitter:PlaySound("pl/creatures/enemy/giant_grub/dig") end),
            TimeEvent(54* FRAMES, function(inst) inst.SoundEmitter:PlaySound("pl/creatures/enemy/giant_grub/dig") end),
        },
    },
    ...
    State
    {
        ...
        onenter = function(inst)
            ...
            if not inst.SoundEmitter:PlayingSound("move") then
                inst.SoundEmitter:PlaySound("pl/creatures/enemy/giant_grub/walk_LP", "move")
            end
	...
	State
	{
		...
		timeline =
		{
			...
			TimeEvent(2 * FRAMES, function(inst) inst.SoundEmitter:PlaySound("pl/creatures/enemy/giant_grub/attack") end),
		},
	...
	State
	{
		...
		onenter = function(inst)
            ...
            inst.SoundEmitter:PlaySound("pl/creatures/enemy/giant_grub/hit")
			inst.Physics:Stop()
		end,
       ...
       timeline =
        {
            ...
            TimeEvent(11 * FRAMES, function(inst) inst.SoundEmitter:PlaySound("pl/creatures/enemy/giant_grub/sleep_in") end),
            TimeEvent(37 * FRAMES, function(inst) inst.SoundEmitter:PlaySound("pl/creatures/enemy/giant_grub/sleep_in") end),
	...
	State
	{
        ...
        timeline=
        {
            TimeEvent(3 * FRAMES, function(inst) inst.SoundEmitter:PlaySound("pl/creatures/enemy/giant_grub/death") end),
        }
	},
}
CommonStates.AddFrozenStates(states)

return StateGraph("giantgrub", states, events, "idle")
