...
local function GetWanderDistFn(inst)
    if TheWorld and not TheWorld.state.isday then
...
local MAX_HARASS_DIST = FOLLOWPLAYER_DIST

local function harassPlayer(inst)
    local x, y, z = inst.Transform:GetWorldPosition()
    local target = FindClosestPlayerOnLandInRangeSq(x, y, z, MAX_HARASS_DIST, true)
...
function PogBrain:OnStart()
    ...
    PriorityNode(
    {
        ...
        IfNode ( function() return TheWorld.state.isfullmoon end, "AporkalypseActive",
