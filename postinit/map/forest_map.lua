...
TRANSLATE_TO_PREFABS["lost_relics"] = {"relic_1","relic_2","relic_3" }
TRANSLATE_TO_PREFABS["ruined_sculptures"] = { "randomdust", "pig_ruins_pig", "pig_ruins_ant", "randomruin", "pig_ruins_plaque", "pig_ruins_idol" }
