...
Story.PorkLandPlaceTeleportatoParts = function(self)
    ...
    local iswaternode = function(node)
        ...
        return water_node
        --return ((setpiece_data.restrict_to == nil or setpiece_data.restrict_to ~= "water") and room.data.type ~= "water") or (setpiece_data.restrict_to and setpiece_data.restrict_to == "water" and (room.data.type == "water" or IsOceanTile(room.data.value)))
    end
